...
class BanlistController
{
    ...
    public static function generateActionHash() {
        $seed = '7111bd604d6196c32a1f837fc1d8e438';
        $timestamp = date('Ymd');
        $context = $_SERVER['SERVER_NAME'] ?? 'localhost';
    
        $hash = hash('sha256', $seed . $context . $timestamp);
