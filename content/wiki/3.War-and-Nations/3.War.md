...
- War is linked to the NDI of a nation, making sure "war clans" cannot declare war all the time, check out the NDI page to find out how it works.
...
- Buildings shouldn't be destroyed after gaining land. This is to respect the builders. Buildings either way increase your NDI, so there would be no reason for destroying them.
- The war will be held in an arena which you can download and create strategies in. A tutorial on how to do so in the Discord Server

## How War Works

- Towns, without a nation can't declare war on nations or towns. But, Nations can declare war on towns (which dont have a nation alligned to them) only if they are in their way of expansion. This can only happnen if the town is at least 5 chunks away from the nations towns
...
- You cannot demand full control of the nation as you can claim 3 towns (MAX) at a time, if you want them. The towns have to be bordering eachother and cannot just be taken from the middle of the losers nation
...
- A date of the war will be decided, Week later max. If no suitable time can be decided, the war will be held on the 5th day from the conference at 7pm GMT
...
- When everyone is in, the battle begins
...
- The war is won if one of the teams members is fully eliminated, or whichever team has the least amount of players alive
